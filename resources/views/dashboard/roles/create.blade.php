...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Pages</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('dashboard/roles.add')</span>
						</div>
					</div>
									...
									<div class="row row-sm">
										@foreach($permissions as $permission)
											<div class="col-md-2 col-sm-6">
												<label class="ckbox"><input type="checkbox" name="permissions[]" value="{{$permission->id}}"><span>{{$permission->name}}</span></label>
											</div>
										@endforeach
