...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">Pages</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('dashboard/users.add')</span>
			</div>
		</div>
								...
								<div class="form-group">
									<div class="row row-sm">
										...
										<div class="col-sm-6">
											...
											<input class="form-control pd-r-80" required type="number" name="age" value="{{old('age')}}">
											@if($errors->has('age'))
