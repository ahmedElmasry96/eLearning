...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Pages</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('dashboard/sidebar.sub_cat')</span>
						</div>
					</div>
								...
								<tbody>
									@foreach($subCategories as $index => $subCat)
										<tr>
											...
											<td>{{$subCat->name}}</td>
											<td>
												@foreach($subCat->categories as $index => $category)
