...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">Pages</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('dashboard/slider.edit')</span>
			</div>
		</div>
						...
						<div class="card card-body pd-20 pd-md-40 border shadow-none">
							<form method="post" action="{{route('sliders.update', $slider->id)}}" enctype="multipart/form-data">
								...
								<div class="form-group">
									<div class="row row-sm">
										<div class="col-sm-6">
											...
											@if($slider->image)
											<img class="mt-2" src="{{url($slider->image)}}" width="200" height="150" alt="slider image">
											@endif
											@if($errors->has('image'))
										...
										<div class="col-md-6">
											<label class="main-content-label tx-11 tx-medium tx-gray-600">@lang('dashboard/app.slogan')</label> 
											<input class="form-control" type="text" name="slogan" value="{{$slider->slogan}}">
								...
								<div class="form-group">
									<div class="row row-sm">
										...
										<div class="col-sm-6">
											...
											<textarea class="form-control" name="paragraph">{{$slider->paragraph}}</textarea>
								...
								<div class="form-group">
									<div class="row row-sm">
										<div class="col-md-6">
											<label class="main-content-label tx-11 tx-medium tx-gray-600">@lang('dashboard/app.button-title')</label> 
											<input class="form-control" type="text" name="button_title" value="{{$slider->button_title}}">
